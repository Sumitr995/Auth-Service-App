...
const DashMain = ({showMenu, setShowMenu, showModal, setShowModal, handleLogout, handleReset, handleVerify}) => {
  return (
    <main className="relative z-1 max-w-6xl mx-auto px-8 py-16">
        {/* Welcome section */}
        <div className="mb-12">
          <h1 className="text-5xl font-bold mb-3">
            <span className="bg-linear-to-r from-white to-gray-400 bg-clip-text text-transparent">Welcome back, John</span>
          </h1>
